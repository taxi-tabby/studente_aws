    ...
    <div className="dashboard-section">
      ...
      <div className="activity-container">
        ...
        <div className="activity-indicator">
          ...
          <div 
            className={`indicator-light ${activityStatus.screen ? 'active' : ''}`} 
        ...
        <div className="activity-indicator">
          <span>Audio:</span>
          <div 
            className={`indicator-light ${activityStatus.audio ? 'active' : ''}`} 
            data-activity="audio"
          ></div>
        </div>
        <div className="activity-indicator">
          <span>Active Window:</span>
          <div className="active-window-name">{activityStatus.activeWindow || 'None'}</div>
        </div>
      </div>
    </div>
  );
